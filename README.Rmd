...
To illustrate the analytic flow without compromising our results with an implicit bias, we are going to use an unnamed complexity function sampled from the `r length(list(wiener,balabanJ,
                     ...
                     meanDistanceDeviation,topologicalInfoContent_entropy,infoTheoreticGCM_entropy))` provided by `QuACN`.
