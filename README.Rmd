...
To illustrate the analysis flow without compromising our results with an implicit bias, we work blindfolded using an unnamed complexity metric sampled from the `r length(compl_list)` metrics provided by the R library `QuACN`.
